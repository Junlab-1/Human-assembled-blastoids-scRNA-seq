...
result = cpdb_statistical_analysis_method.call(
    ...
    meta_file_path = "./ChimericB_meta.txt",              # mandatory: tsv file defining barcodes to cell label.
    counts_file_path = './ChimericB_counts.txt',# mandatory: normalized count matrix.
